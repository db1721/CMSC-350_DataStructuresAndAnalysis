...
public class Polynomial implements Iterable<Polynomial.Term>, Comparable<Polynomial> 
{
    ...
    /******************************************************************************* 
     * DESCRIPTION: 
     * splits the String into individual term nodes and creates a linked list from
     * the extracted terms
     ******************************************************************************/
    // ===============================================================================================
    // method: addTerm / arguments: double coefficient and integer exponent
    // description: if head is null, new term is null, Otherwise sets new term to
    // next null term.next
    // ===============================================================================================
    ...
    // ===============================================================================================
    // method: overridden compareTo via Comparable / Arguments: Another Polynomial
    // object
    // description: First compares exponents, then coefficients. A positive value
    // indicate this is
    ...
    // description: compares exponents in two polynomials, is called to check weak
    // order
    // ===============================================================================================
    ...
    // ===============================================================================================
    // method: overridden Iterator via Iterable / Implemented methods hasNext and
    // next
    ...
    // ===============================================================================================
    // method: overridden toString / Description: using StringBuilder, traverses the
    // the expression
    // adding the the string value of the term. Adds the operator based off
    // coefficient sign.
    // ===============================================================================================
    @Override
    ...
    // ===============================================================================================
    // Nested Class: Term / arguments: double coefficient and int exponent /
    // overridden toString
    // description: nodes of the polynomial objects which cary the reference to the
    // next node
    // ===============================================================================================
